/*
 * XIRR.java Copyright (C) 2005 Gautam Satpathy gautam@satpathy.in
 * www.satpathy.in
 *
...
public class XIRR {
     ...
     * calculations. By default, January 1, 1900 is serial number 1, and January
    ...
    public static double xirr(XIRRData xirrData) {
        ...
        status = GoalSeek.goalSeekNewton(new XIRRNPV(), null, data, xirrData, rate0);
