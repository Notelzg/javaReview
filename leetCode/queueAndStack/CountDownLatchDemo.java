...
public class CountDownLatchDemo {
    ...
    static final ThreadLocal<Map<String, String>> context1 = new ThreadLocal<>();

    @Test
    public void testThread() {
        // 从上下文中拿出 Map
        Map<String, String> contextMap = context.get();
        Map<String, String> contextMap1 = context.get();
        if (contextMap == null) {
            contextMap = new HashMap<>();
        }
        if (contextMap1 == null) {
            contextMap1 = new HashMap<>();
        }

        contextMap.put("key1", "value1");
        contextMap1.put("key1", "value1111");
        context.set(contextMap);
        context1.set(contextMap1);
    ...
    private String getFromComtext() {
        ...
        String value2 = context1.get().get("key1");
        System.out.println("从 ThreadLocal 中取出上下文，key1 对应的值为：{}" +  value2);
        return value1;
    }
}
